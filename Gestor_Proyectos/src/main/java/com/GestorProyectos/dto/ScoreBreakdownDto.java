...
public class ScoreBreakdownDto implements Serializable {
    ...
    // ── AI enrichment (populated by AiScoringService, null if no API key) ─────
    /** 1-2 sentence recruiter summary generated by Claude. */
    private String aiSummary;

    /** 3 key recruiter insights generated by Claude. */
