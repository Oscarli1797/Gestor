      ...
      <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg p-8 shadow-sm">
        ...
        <div className="mt-5">
          ...
          <a
            ...
            className="mt-3 flex items-center justify-center gap-2 w-full border border-gray-300 rounded py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors"
          >
